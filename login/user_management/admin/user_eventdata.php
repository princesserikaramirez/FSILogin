...
<?php
	...
	$sql3 = "SELECT * FROM documents where page='2' 
	 order by date desc limit $page1,5";
	$sql33 = "SELECT * FROM documents where page='2'AND NOT ODG_ID = 0
	AND NOT CIRSS_ID = 0
	AND NOT CPRSD_ID = 0
	AND NOT AFSD_ID = 0
	AND NOT SECTION_ID order by date desc ";
...
<?php
		...
		echo "<br>";echo "<br>";
			...
			for($b=1;$b<=$a;$b++)
			{
				...
				?><a href="event.php?page=<?php echo $b; ?>" style="text-decoration:none"><?php echo $b." "; ?></a> <?php
			}
