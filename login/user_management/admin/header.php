<html lang="en">
	...
	<meta name="viewport" content="width=device-width, initial-scale=1.0">
				<link type="text/css" href="/FSILogin/assets/bootstrap/css/freelancer.css" rel="stylesheet">
...
<!-- site-header -->
		...
		<nav class="navbar navbar-default navbar-fixed-top">
			<div class="navbar-inner">
				<div class="container">
					...
					<a class="brand" href="home.php?page=1">
						DMS-FSI
					</a>
	...
	<script src="/FSILogin/assets/scripts/jquery-1.9.1.min.js" type="text/javascript"></script>
	<script src="/FSILogin/assets/scripts/jquery-ui-1.10.1.custom.min.js" type="text/javascript"></script>
	<script src="/FSILogin/assets/bootstrap/js/bootstrap.min.js" type="text/javascript"></script>
	<script src="/FSILogin/assets/scripts/datatables/jquery.dataTables.js"></script>
