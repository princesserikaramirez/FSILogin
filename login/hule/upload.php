...
<?php
	...
	$sql2 = "SELECT * FROM admin WHERE user_id='admin'";
...
<?php
	...
	if (isset($_POST['submit']))
	{
		...
		if ($name && $doc_name)
		{
			...
			(name,path,page,description,date,ODG_ID,CIRSS_ID,CPRSD_ID,AFSD_ID,SECTION_ID,fileName,adm_aprvl) 
			VALUES 
			('$doc_name','$location','$file_page','$description',now()
			,'$odg','$cirss','$cprsd','$afsd','$section','$name','$aprvl');
			INSERT INTO logs 
