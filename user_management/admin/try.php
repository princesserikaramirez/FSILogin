...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="/FSI/Assets/css/font-awesome.min.css">
    <link rel="stylesheet" type="text/css" href="/FSI/Assets/css/bootstrap.min.css">
    <link rel="stylesheet" type="text/css" href="/FSI/Assets/css/imagehover.min.css">
    <link rel="stylesheet" type="text/css" href="/FSI/Assets/css/style.css">
    <!-- =======================================================
        Theme Name: Mentor
  ...
  <body>
    ...
    <script src="/FSI/Assets/js/jquery.min.js"></script>
    <script src="/FSI/Assets/js/jquery.easing.min.js"></script>
    <script src="/FSI/Assets/js/bootstrap.min.js"></script>
    <script src="/FSI/Assets/js/custom.js"></script>
    <script src="/FSI/Assets/contactform/contactform.js"></script>
