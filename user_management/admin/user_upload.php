...
<form action="user_upload.php" method="post" enctype="multipart/form-data">
			...
			value="2"><b>&nbsp HOME &nbsp &nbsp &nbsp </b>
			<input type="radio" name="page"
			<?php if (isset($page) && $page=="events") echo "checked";?>
			value="1"><b>&nbsp EVENTS </b>
			
			</br></br><label><b>TITLE</label></b>
			<input type="text" style="width: 443px" name="doc_name"></br>
			<input type="file" name="myfile"></br>
			
			</br><label><b>DESCRIPTION</label></b>
			<input type="text" maxlength="500" style="height: 180px;width: 443px" name="desc"></br>
